...
def dashboard():
	...
	for grow in grows:
		...
		seed_data.append({"grow_name": grow['grow_name'], "pH" :pH_list.reverse(), "lux" :lux_list.reverse(), "EC" :EC_list.reverse(), \
				"TDS" :TDS_list.reverse(), "PS" : PS_list.reverse(), "humidity": humidity_list.reverse(), "airTemp" : airTemp_list.reverse(),\
				 "waterTemp": waterTemp_list.reverse()})
